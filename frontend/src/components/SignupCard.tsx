import { SignupType } from "@ankan_biswas/edtech-common";
...
export const SignupCard = ({ type }: { type: "signup" | "signin" }) => {
    ...
    return (
        <div className="h-screen flex justify-center items-center bg-slate-300">
            <div className="w-[400px] h-auto rounded-2xl overflow-hidden shadow-lg bg-white p-5">
                <div className="mt-4">
                    <h3 className="text-xl font-bold text-gray-900 pl-20">Create an Account</h3>
                    ...
                    <Button onClick={handleSendRequest} value={"Sign up"} />
                    <div className="">
